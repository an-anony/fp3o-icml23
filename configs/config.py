...
def get_config():
    ...
    parser.add_argument("--algorithm_name", type=str,
                        default="fp3o_sep", choices=["fp3o_sha","fp3o_sep","fp3o_par","rfp3o_sha","rfp3o_sep","rfp3o_par"])
    parser.add_argument("--experiment_name", type=str, 
                        default="debug", help="an identifier to distinguish different experiment.")
    ...
    parser.add_argument("--n_rollout_threads", type=int, 
                        default=8, help="Number of parallel envs for training rollouts")
    ...
    parser.add_argument("--env_name", type=str, 
                        default='mujoco', choices=["StarCraft2","mujoco"], help="specify the name of environment")
    ...
    parser.add_argument("--partial_share", action='store_true',
                        default=False, help='Whether agent share the same policy partially')
