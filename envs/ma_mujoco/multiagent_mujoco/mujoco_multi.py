...
#         self.obs_size_init = self.get_obs_size_init()
...
#                              self.mujoco_globals,
#                              self.global_categories,
#                              vec_len=getattr(self, "obs_size_init", None))
...
#             agent_id_feats = np.zeros(self.n_agents, dtype=np.float32)
#             agent_id_feats[a] = 1.0
#             # share_obs.append(np.concatenate([state, agent_id_feats]))
