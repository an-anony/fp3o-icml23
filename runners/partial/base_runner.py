...
class Runner(object):
    ...
    def train(self):
        ...
        for stage, agent_pair in enumerate(agents_pairs):
                ...
                for agent_id in agent_pair:
                    ...
                    with torch.no_grad():
                        if self.use_recurrent_policy:
                            ...
                            old_actions_logprob, _ =self.trainer.policy.actor.evaluate_actions(*input, agent_head=agent_id)
            ...
            train_info_pair = parallel_trainer.train(buffer_pair, agent_heads=agent_pair)
            ...
            if stage == 0:
                for agent_id in agent_pair:
                    ...
                    with torch.no_grad():
                        if self.use_recurrent_policy:
                            input = self.buffer[agent_id].data_chunk(self.data_chunk_length)
                            new_actions_logprob, _ =self.trainer.policy.actor.evaluate_actions(*input, agent_head=agent_id)
