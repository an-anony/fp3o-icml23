...
import torch
from runners.partial.base_runner import Runner
    ...
    def collect(self, step):
        ...
        for agent_id in range(self.num_agents):
            value, action, action_log_prob, rnn_state, rnn_state_critic \
                = self.trainer.policy.get_actions(self.buffer[agent_id].share_obs[step],
        ...
        while True:
            ...
            for agent_id in range(self.num_agents):
                eval_actions, temp_rnn_state = \
                    self.trainer.policy.act(eval_obs[:,agent_id],
